...
class _UserHomeState extends State<UserHome> {
  Stream<int> getJumlahDisposisi() {
    // Hanya disposisi untuk user yang sedang login
    return FirebaseFirestore.instance
        .collection('disposisi')
        .where('jabatan', isEqualTo: widget.jabatanUser)
        .snapshots()
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      "Halo ${widget.namaUser}, lihat disposisi masuk Anda di bawah.",
            ...
            StreamBuilder<int>(
              ...
              builder: (context, snapshot) {
                ...
                return _menuCard(
                  ...
                  title: "$count Disposisi Masuk",
                  subtitle: "Surat disposisi yang ditujukan untuk Anda",
                  badgeValue: count,
